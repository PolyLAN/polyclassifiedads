...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdSeen'
        db.create_table(u'polyclassifiedads_adseen', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polyclassifiedads.Ad'])),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'polyclassifiedads', ['AdSeen'])


    def backwards(self, orm):
        # Deleting model 'AdSeen'
        db.delete_table(u'polyclassifiedads_adseen')
    ...
    models = {
        ...
        u'polyclassifiedads.adnotification': {
            ...
            'filter_types': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'polyclassifiedads.adphoto': {
            'Meta': {'object_name': 'AdPhoto'},
            'ad': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['polyclassifiedads.Ad']", 'null': 'True', 'blank': 'True'}),
            'file': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'polyclassifiedads.adseen': {
            'Meta': {'object_name': 'AdSeen'},
            'ad': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['polyclassifiedads.Ad']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
