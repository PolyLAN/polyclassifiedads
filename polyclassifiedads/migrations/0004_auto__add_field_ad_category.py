...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ad.category'
        db.add_column(u'polyclassifiedads_ad', 'category',
                      self.gf('django.db.models.fields.CharField')(default='togive', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ad.category'
        db.delete_column(u'polyclassifiedads_ad', 'category')
