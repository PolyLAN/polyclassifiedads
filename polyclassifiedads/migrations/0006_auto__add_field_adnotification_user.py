...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdNotification.user'
        db.add_column(u'polyclassifiedads_adnotification', 'user',
    ...
    def backwards(self, orm):
        # Deleting field 'AdNotification.user'
        db.delete_column(u'polyclassifiedads_adnotification', 'user_id')
