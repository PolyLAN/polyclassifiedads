...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'polyclassifiedads_ad', 'type',
                      self.gf('django.db.models.fields.CharField')(default='tosell', max_length=64),
                      keep_default=False)

        # Adding field 'AdNotification.filter_types'
        db.add_column(u'polyclassifiedads_adnotification', 'filter_types',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'polyclassifiedads_ad', 'type')

        # Deleting field 'AdNotification.filter_types'
        db.delete_column(u'polyclassifiedads_adnotification', 'filter_types')
