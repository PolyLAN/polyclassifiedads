...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ad.offline_date'
        db.alter_column(u'polyclassifiedads_ad', 'offline_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Ad.online_date'
        db.alter_column(u'polyclassifiedads_ad', 'online_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Ad.offline_date'
        db.alter_column(u'polyclassifiedads_ad', 'offline_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Ad.online_date'
        db.alter_column(u'polyclassifiedads_ad', 'online_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
