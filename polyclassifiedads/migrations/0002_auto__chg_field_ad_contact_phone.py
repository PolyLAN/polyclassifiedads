...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ad.contact_phone'
        db.alter_column(u'polyclassifiedads_ad', 'contact_phone', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'Ad.contact_phone'
        db.alter_column(u'polyclassifiedads_ad', 'contact_phone', self.gf('django.db.models.fields.TextField')(max_length=32, null=True))
